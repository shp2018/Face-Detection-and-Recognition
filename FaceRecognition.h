...
void addFace()
{
    ...
    if (!face_cascade.load("/Users/kevinpark/Desktop/opencv-master/data/haarcascades/haarcascade_frontalface_alt.xml"))
    {
        cout << "error" << endl;
        return ;
    };
...
void  FaceRecognition() {
	...
	Mat testSample = imread("/Users/kevinpark/Desktop/test.jpg", 0);
